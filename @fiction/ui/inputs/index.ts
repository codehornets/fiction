...
export const inputs = {
  ...
  InputNav: { el: def(() => import('./InputNav.vue')), shape: ['0.icon.*', '0.iconAfter.*', '0.figure.*', '0.badge.*', '0.list.*', '0.media.*', '0.basePath', '0.description', '0.design', '0.emphasis', '0.href', '0.id', '0.info', '0.isActive', '0.isDisabled', '0.isHidden', '0.label', '0.onAuthState', '0.priority', '0.subLabel', '0.target', '0.testId', '0.theme', '0.value', '0.variant'] },
  ...
  InputIcon: { el: def(() => import('./InputIcon.vue')), shape: ['url', 'format', 'html', 'iconId', 'el', 'class', 'props', 'alt'] },
