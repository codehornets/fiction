  ...
  it('site editing', { timeout: 80000, retry: isCi() ? 3 : 0 }, async () => {
    ...
    await kit.performActions({
      ...
      actions: [
        ...
        { type: 'frameInteraction', frameSelector: `#site-builder-iframe`, frameActions: [
          { type: 'hasText', selector: `[data-option-path="items.0.title"]`, text: 'hello' },
          { type: 'hasText', selector: `[data-option-path="items.0.subTitle"]`, text: 'world' },
        ] },
        { type: 'click', selector: `[data-test-id="publishChangesButton"]` },

        { type: 'frameInteraction', frameSelector: `#site-builder-iframe`, frameActions: [
          { type: 'fill', selector: `[data-option-path="items.0.title"]`, text: 'change' },
          { type: 'fill', selector: `[data-option-path="items.0.subTitle"]`, text: 'the text' },
        ] },
