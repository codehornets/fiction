  ...
  <div class="z-10" :class="card.classes.value.contentWidth">
    <div class=" px-4 lg:px-0">
      ...
      <div class="text-center">
        <a href="https://www.fiction.com" title="Create a Personal Website and Email List" class="text-theme-300/80 dark:text-theme-600/80 dark:hover:text-primary-400 hover:text-primary-500 transition-all">
