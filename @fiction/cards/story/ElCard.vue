...
import XProse from '@fiction/ui/prose/XProse.vue'
...
<template>
  <div>
    <div v-for="(item, i) in uc.items" :key="i" class="py-[4vw] px-4">
      <div class="md:flex gap-8 md:gap-16 lg:gap-20 relative" :class="card.classes.value.contentWidth">
        ...
        <div class=" md:w-[70%] grow">
          <EffectScrollReveal class="space-y-6" :disable="card.site?.isEditable.value">
            <CardText
              ...
              class="prose dark:prose-invert prose-sm md:prose-md lg:prose-xl text-xl sm:text-3xl lg:text-4xl xl:text-5xl !leading-relaxed"
